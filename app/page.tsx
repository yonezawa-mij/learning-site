...
import { getHomeDemoQuiz } from '@/lib/demo-quiz'
...
export default async function Home() {
  ...
  const demoQuiz = await getHomeDemoQuiz()
      ...
      <main className="flex-1">
        ...
        <section id="quiz" className="border-t border-border bg-stone-50/50 py-20">
          <div className="mx-auto max-w-3xl px-6 space-y-20">
            {demoQuiz && (
              <div>
                <div className="text-center mb-10">
                  ...
                  <h2 className="mt-2 text-2xl font-bold sm:text-3xl">定番体験クイズ</h2>
                  <p className="mt-3 text-muted max-w-lg mx-auto">
                    最初につくった固定の英会話問題です。すぐに試せるので、まずはこちらからどうぞ。
                  </p>
                </div>
                <HomeDemoQuiz
                  lessonTitle={demoQuiz.lessonTitle}
                  isPremium={isPremium}
            ...
            <div id="ai-quiz">
              <div className="text-center mb-10">
                <p className="text-sm font-medium tracking-wide text-violet-700 uppercase">AI powered</p>

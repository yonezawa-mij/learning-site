...
function LoginForm() {
  ...
  return (
    <div className="w-full max-w-md rounded-2xl border border-border bg-white p-8 shadow-sm">
      <h1 className="text-2xl font-bold">{SITE_NAME} にログイン</h1>
      <p className="mt-2 text-sm text-muted">会員アカウントでログインしてください</p>
      ...
      <form action={formAction} className="mt-6 space-y-4">
        ...
        <div>
          ...
          <input id="password" name="password" type="password" required className="w-full rounded-xl border border-border px-4 py-3 outline-none focus:border-accent" />
        </div>
